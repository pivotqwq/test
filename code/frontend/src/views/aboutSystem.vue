...
export default {
  ...
  data() {
    return {
      aboutItems: [
        "我们是一支来自福州大学的大二学生团队。这个项目是我们的数据库课程实践，一个将理论知识付诸实践的宝贵机会。",
        "我们对技术充满热情，希望通过本次项目，不仅能够深化对数据库原理的理解，更能锻炼我们的软件开发和团队协作能力。",
        "从概念设计到最终实现，我们团队的每一位成员都倾注了努力和思考，力求打造一个功能完善、运行稳定的应用程序。",
        "这个项目不仅是我们的课程作业，更是我们探索、学习和成长的见证。感谢您的关注与支持！"
      ]
    }
  },
  methods: {
